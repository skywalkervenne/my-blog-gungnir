...
<p>通过插件 <RouterLink to="/zh/docs/plugins/chart/">plugin-chart</RouterLink> 来在 Markdown 中使用 JavaScript 图表库 <a href="https://www.chartjs.org" target="_blank" rel="noopener noreferrer">Chart.js</a>：</p>
...
}"></Chart><details class="custom-container details"><summary>代码</summary>
